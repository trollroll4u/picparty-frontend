...
function EventScreen() {
  ...
  const [comments, setComments] = useState<CommentDatanew[]>(exampleComments);
  ...
  return (
    <>
      ...
      >
        <br></br>
        <h1 className="text-center text-light">THE BEST WEBSITE IN THE WORLD </h1>
        <p className="text-center text-light">created by ohad albagly and yuval ron</p>
        <div>
          <div className="row text-center" style={{backgroundColor: "black"}}>
            ...
            <div
              className="row"
              style={{ width: "50%", backgroundColor: "black", margin: "auto" }}
            >
              <CommentsScreen
                comments={comments}
